    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Clip wrapper — overflow:hidden prevents x-translation from extending iOS layout viewport */}
          ...
          <motion.div
            ...
            className="absolute top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl flex flex-col pointer-events-auto"
